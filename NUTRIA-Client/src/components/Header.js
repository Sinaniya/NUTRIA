                ...
                <AppBar position="static" style={{
                    ...
                    <Toolbar style={{
                        ...
                        >
                            ...
                            <MenuItem onClick={this.menuItemsClickCloseHandler}>About Us</MenuItem>
                            <MenuItem onClick={this.menuItemsClickCloseHandler}>Contact Us</MenuItem>
                        </Menu>
...
const mapStateToProps = state => {
    const {languages, defaultLanguage, currentLanguage} = state.lang;
    return {
        languages: languages,
