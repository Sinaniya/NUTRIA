...
public class SettingsActivity extends PreferenceActivity implements
    ...
    private void setPrinterList(String printModel) {
        ...
        try {
            ...
            // call the NetPrinterListActivity when port is NET
            if (port.equalsIgnoreCase("NET")) {
                Intent printerList = new Intent(this, NetPrinterListActivity.class);
            ...
            } else // call the BluetoothPrinterListActivity when port is Bluetooth
            {
