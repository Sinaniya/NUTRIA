...
/**
 * The type Printer settings activity.
 */
public class PrinterSettingsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            ...
            setDisplayFile(file);
            mBtnPrint.setBackgroundColor(R.color.colorPrimary);
    ...
    public void selectFileButtonOnClick() {
        ...
        final Intent fileList = new Intent(PrinterSettingsActivity.this,
    ...
    private void NetPreferenceButtonOnClick() {
        startActivity(new Intent(this, NetSettingsActivity.class));
    }
}
