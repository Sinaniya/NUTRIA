...
const store = new Vuex.Store({
  ...
  getters: {
	...
	bazoTransactions: function (state) {
      return state.config.transactions;
    },
	...
	updateTransactions: function (state, transaction) {
        let newTransaction = {
        ...
        state.config.transactions.push(newTransaction);
    },
	...
	updateTransactions: function (context, transaction) {
      return context.commit('updateTransactions', transaction);
    },
