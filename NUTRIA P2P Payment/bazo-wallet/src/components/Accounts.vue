      ...
      <div class="pos-rel user-funds-content">
            ...
            <template slot="qr" scope="item">
              <div>
                <b-popover triggers="hover" :content="Translation.t('userAccounts.explorer')" class="popover-element">
                  <a :href="'https://rinkeby.etherscan.io/address/' + item.item.bazoaddress" target="_blank">
        ...
        <div class="col-12">
          <form>
			...
			<b-form-fieldset :label="Translation.t('userAccounts.fields.bazoprivate')">
              <b-form-input v-model="bazoprivate" type="text"></b-form-input>
            </b-form-fieldset>
